...
class DynamicHead(nn.Module):
    ...
    def __init__(self, cfg, roi_input_shape):
        ...
        # Build heads.
        num_classes = cfg.MODEL.RandBox.NUM_CLASSES
        d_model = cfg.MODEL.RandBox.HIDDEN_DIM
        dim_feedforward = cfg.MODEL.RandBox.DIM_FEEDFORWARD
        nhead = cfg.MODEL.RandBox.NHEADS
        dropout = cfg.MODEL.RandBox.DROPOUT
        activation = cfg.MODEL.RandBox.ACTIVATION
        num_heads = cfg.MODEL.RandBox.NUM_HEADS
        rcnn_head = RCNNHead(cfg, d_model, num_classes, dim_feedforward, nhead, dropout, activation)
        self.head_series = _get_clones(rcnn_head, num_heads)
        self.num_heads = num_heads
        self.return_intermediate = cfg.MODEL.RandBox.DEEP_SUPERVISION
        ...
        if self.use_focal or self.use_fed_loss:
            prior_prob = cfg.MODEL.RandBox.PRIOR_PROB
...
class RCNNHead(nn.Module):
    ...
    def __init__(self, cfg, d_model, num_classes, dim_feedforward=2048, nhead=8, dropout=0.1, activation="relu",
        ...
        # cls.
        num_cls = cfg.MODEL.RandBox.NUM_CLS
        cls_module = list()
        ...
        # reg.
        num_reg = cfg.MODEL.RandBox.NUM_REG
        reg_module = list()
...
class DynamicConv(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.dim_dynamic = cfg.MODEL.RandBox.DIM_DYNAMIC
        self.num_dynamic = cfg.MODEL.RandBox.NUM_DYNAMIC
